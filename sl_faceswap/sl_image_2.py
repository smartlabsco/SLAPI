...
class FaceswapParser:
    ...
    def parsing(self, source_img_path, target_img_path, merge_result=True, need_align=True):
        # load model
        ...
        if need_align:
            ...
            self.face_align(landmarkModel, source_img_path)
            self.face_align(landmarkModel, target_img_path, merge_result=True, image_size=224)
        ...
        for img_path in img_list:
            ...
            cv2.imwrite('./data/parsingimg_2/result/PARSE_OUTPUT.png', res)
            print("*********************DONE*********************")
        os.chdir('../')

if __name__ == '__main__':
    parser = FaceswapParser()
    parser.parsing('./data/parsingimg_2/source/UPLOAD_IMG_source.png', './data/parsingimg_2/target/UPLOAD_IMG_target.png')
