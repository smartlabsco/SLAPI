...
class FaceswapParser:
    ...
    def parsing(self, image, need_align=True):
        os.chdir('/home/smartlabs/apitest/sl-parsing-api/sl_faceswap')
        image = 'UPLOAD_IMG.png'
        print(os.getcwd())
        ...
        for idx, target_aligned_image in enumerate(target_aligned_images):
            print('3')
            #print(id_net)
            print(source_aligned_images[idx % len(source_aligned_images)][0])
            #print(source_aligned_images)
